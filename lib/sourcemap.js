...
(function() {
  ...
  SourceMap = (function() {
    var V3_SOURCEMAP_REGEX, formatSourcePosition;
    ...
    formatSourcePosition = function(frame, getSourceMapping) {
      var column, fileLocation, fileName, line, source, sourceColumn, sourceFile, sourceLine;
      fileName = void 0;
      fileLocation = '';
      if (frame.isNative()) {
        ...
        return fileLocation = source ? ((sourceFile = source[0], sourceLine = source[1], sourceColumn = source[2], source), "" + sourceFile + ":" + (sourceLine + 1) + ":" + (sourceColumn + 1)) : "" + fileName + ":" + line + ":" + column;
      }
    };

    SourceMap.registerErrorHandler = function() {
      var getSourceMap, getSourceMapping, sourceMapCache;
      sourceMapCache = {};
